...
1. [ECVL & EDDL environment for potential developers](https://github.com/deephealthproject/winter-school/tree/main/lab/00_ecvl_eddl_environment)
    
    Monday afternoon from 3 PM to 5 PM.

    Presentation and brief explanation of the main features of both ECVL and EDDL libraries.


2. [Installation and configuration of ECVL & EDDL](https://github.com/deephealthproject/winter-school/tree/main/lab/01_installation)
...
3. Lab exercises to be run in non-distributed mode using datasets from several DeepHealth use cases
